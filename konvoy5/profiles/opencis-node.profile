...
title: 'Open Computing Information Security Profile for Konvoy Node'
...
selections:
    ...
    #- file_permissions_konvoy_node_client_crt
    #- file_owner_konvoy_node_client_crt
    #- file_groupowner_konvoy_node_client_crt
