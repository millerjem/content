...
title: 'Open Computing Information Security Profile for Konvoy Master Node'
...
selections:
    ...
    #- file_groupowner_master_konvoy_conf
    #- file_groupowner_master_konvoy_kubeconfig
    ...
    #- file_owner_master_konvoy_conf
    #- file_owner_master_konvoy_kubeconfig
    ...
    #- file_permissions_master_konvoy_conf
    #- file_permissions_master_konvoy_kubeconfig
